...
const themes: { [key: string]: ThemeColors } = {
  dark: {
    ...
    solarizedDark: {
      ...
      gitBranchColors: [
        '#b58900', '#268bd2', '#2aa198', '#dc322f', '#6c71c4', '#859900', '#cb4b16', '#d33682',
      ],
    ...
    nord: {
      ...
      gitBranchColors: [
        '#81a1c1', '#8fbcbb', '#ebcb8b', '#bf616a', '#b48ead', '#5e81ac', '#d08770', '#a3be8c',
      ],
    ...
    dracula: {
      ...
      gitBranchColors: [
        '#bd93f9', '#8be9fd', '#f1fa8c', '#ff5555', '#ff79c6', '#50fa7b', '#ffb86c', '#6272a4',
      ],
    ...
    monokai: {
      ...
      gitBranchColors: [
        '#a6e22e', '#fd971f', '#f92672', '#66d9ef', '#ae81ff', '#f8f8f2', '#75715e', '#49483e',
      ],
      gitCommitStroke: '#f8f8f2',
      gitMergeDot: '#75715e',
